...
} // function para renderizar todos los paises.. en el return abajo los mapeo
...
async function zoomCountry(e, index)  {
 ...
 let result = data.slice(indexes); // asi filtro el index dentro de la api (data) y me retorna una nueva que es el pais al que le di click 
...
return(
  ...
  setNative(
    function nativoNombre() {
      ...
      let nombreNativo = Object.keys(nnativo); // aqui obtengo la key dynamic de el nested object de arriba
      ...
      }),                                   // el signo " ? " tbn ayuda para que el browser no se paralice si lee undefined la expression
...
function zoomOut() {
 ...
 //"name":
      //{"common":"Serbia","official":"Republic of Serbia",
        //"nativeName":{"srp":{"official":"Република Србија","common":"Србија"}}
 
       // "name":
       //{"common":"Cameroon","official":"Republic of Cameroon",
          //"nativeName":{"eng":{"official":"Republic of Cameroon","common":"Cameroon"}
